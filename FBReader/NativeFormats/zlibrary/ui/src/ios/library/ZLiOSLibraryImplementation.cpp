...
#include "../filesystem/ZLiOSFSManager.h"

class ZLiOSLibraryImplementation : public ZLibraryImplementation {
...
void initLibrary() {
	new ZLiOSLibraryImplementation();
}

void ZLiOSLibraryImplementation::init(int &argc, char **&argv) {
	ZLibrary::parseArguments(argc, argv);

	ZLiOSFSManager::createInstance();
}
