...
class ZLiOSFSManager : public ZLUnixFSManager {
...
inline ZLiOSFSManager::ZLiOSFSManager() {}
inline void ZLiOSFSManager::createInstance() { ourInstance = new ZLiOSFSManager(); }

inline bool ZLiOSFSManager::useNativeImplementation(const std::string &path) {
